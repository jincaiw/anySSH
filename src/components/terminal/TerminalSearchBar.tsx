...
export function TerminalSearchBar({ sessionId }: TerminalSearchBarProps) {
  ...
  return (
    ...
    >
      ...
      <button
        onClick={handlePrev}
        title={t("terminal.search.previousHint")}
      ...
      <button
        onClick={handleNext}
        title={t("terminal.search.nextHint")}
      ...
      <button
        ...
        aria-label={t("terminal.search.toggleCaseSensitivity")}
      ...
      <button
        ...
        aria-label={t("terminal.search.toggleRegex")}
        aria-pressed={regex}
      ...
      <button
        onClick={handleClose}
        title={t("terminal.search.closeHint")}
