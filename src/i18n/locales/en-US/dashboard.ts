...
export default {
  ...
  "protocol.port": "Port",
  "protocol.device": "Serial device",
  "protocol.baud": "Baud rate",
  "protocol.dataBits": "Data bits",
  "protocol.stopBits": "Stop bits",
  "protocol.parity": "Parity",
  "protocol.flow": "Flow control",
  "protocol.none": "None",
  "protocol.even": "Even",
  "protocol.odd": "Odd",
  "protocol.hardware": "Hardware",
  "protocol.software": "Software",
  "protocol.shell": "Shell executable",
  "protocol.directory": "Start directory",
  "protocol.systemDefault": "Use system default",
  "protocol.username": "Username",
  "protocol.password": "Password",
  "protocol.expect": "Wait for",
  "protocol.send": "Send",
  "protocol.bookmark": "Name, group and notes",
  "protocol.label": "Connection name",
  "protocol.group": "Group",
  "protocol.noGroup": "No group",
  "protocol.notes": "Notes",
  "protocol.saveAfterConnect": "Save to hosts after connecting",
  "protocol.scriptProtected": "Login scripts are encrypted in the credential vault.",
  "protocol.scriptUnavailable": "Cannot read the saved login script. Unlock the credential vault and retry.",
  "protocol.invalidBaud": "Baud rate must be an integer from 1 to 4000000.",
  "protocol.invalidParams": "Saved connection parameters are invalid. Edit and retry.",
  "protocol.saveFailed": "Connected, but the host could not be saved.",
  "protocol.serialExclusive": "A serial device cannot have multiple simultaneous sessions.",
  "protocol.certificateFirst": "First connection to this RDP server. Verify its certificate fingerprint before trusting it.",
  "protocol.certificateChanged": "This server’s certificate has changed. Verify the new fingerprint with the administrator before connecting.",
  "protocol.previousCertificate": "Previous fingerprint",
  "protocol.trustCertificate": "Trust certificate and connect",
  "protocol.domain": "Domain (optional)",
  "protocol.savePassword": "Remember password (stored in the OS keychain)",
  "protocol.credentialLoaded": "Saved password loaded from the keychain",
  // ─── Page chrome ────────────────────────────────────────────────────────
  title: "Hosts",
  subtitle:
  ...
  "heading.hosts": "Hosts",
  "heading.cloudStorage": "Object Storage",

  // ─── Action buttons ─────────────────────────────────────────────────────
  "action.newServer": "SSH",
  "action.newServerHint": "New SSH connection (Cmd+T)",
  "action.newS3": "Object Storage",
  "action.newS3Hint": "New object storage connection (S3 compatible)",
  ...
  "rdp.usernamePlaceholder": "Username (leave empty to log in on the remote screen; required with NLA)",
  ...
  "rdp.reconnecting": "Connection lost — reconnecting ({attempt}/{max})…",
  "rdp.importRdp": "Import .rdp file",
  "rdp.importRdpFailed": "Could not parse the .rdp file.",
  "rdp.fullscreen": "Fullscreen",
  "rdp.exitFullscreen": "Exit fullscreen",
  "rdp.sendFiles": "Send files to remote",
  "rdp.filesOffered": "Remote clipboard offers {count} file(s)",
  "rdp.saveFiles": "Save to…",
  "rdp.fileTransferFailed": "File transfer failed: {error}",
  "rdp.fileTransferDone": "File transfer complete",
  "rdp.fileUnsupported": "File content unavailable",
