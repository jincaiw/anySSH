...
export default {
  ...
  "data.importHint": "Restore from a backup file. This replaces all current data and restarts anySCP.",
  "data.importAction": "Import…",

  "backup.selectFileTitle": "Select anySCP backup",
  "backup.saveFileTitle": "Save anySCP backup",
  "backup.fileFilter": "anySCP backup",
  ...
  "data.clearAllHint":
    "Permanently delete every saved host, group, connection history entry, snippet, port-forward rule, and S3 connection — along with their stored credentials and all app preferences. anySCP restarts at first-launch state. This can’t be undone.",
  ...
  "reset.bodySuffix":
    "saved hosts, groups, history, snippets, port-forward rules, S3 connections, stored credentials, and preferences. anySCP will restart fresh. This action cannot be undone.",
