...
export default {
  ...
  "protocol.domain": "域（可选）",
  "protocol.savePassword": "记住密码（存入系统钥匙串）",
  "protocol.credentialLoaded": "已从钥匙串载入保存的密码",
  // ─── Page chrome ────────────────────────────────────────────────────────
  title: "主机",
  ...
  "rdp.usernamePlaceholder": "用户名（可留空，登录屏输入；NLA 需填写）",
  ...
  "rdp.reconnecting": "连接中断，正在自动重连（{attempt}/{max}）…",
  "rdp.importRdp": "导入 .rdp 文件",
  "rdp.importRdpFailed": "无法解析 .rdp 文件。",
  "rdp.fullscreen": "全屏",
  "rdp.exitFullscreen": "退出全屏",
  "rdp.sendFiles": "发送文件到远程",
  "rdp.filesOffered": "远程剪贴板包含 {count} 个文件",
  "rdp.saveFiles": "保存到…",
  "rdp.fileTransferFailed": "文件传输失败：{error}",
  "rdp.fileTransferDone": "文件传输完成",
  "rdp.fileUnsupported": "文件内容暂不可用",
